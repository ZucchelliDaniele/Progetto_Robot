...
var JoyStick = (function(container, parameters, callback)
{
    ...
    canvas.id = title;
    canvas.className = "mx-auto" //ZONE CENTER
...
function DropDownMenu(dropdownMenuID, dropdownButtonID) {
    ...
    document.addEventListener('click', function (event) {
        ...
        if(!dropdownMenu.contains(target) && !dropdownButton.contains(target)) {
            ...
            dropdownMenu.classList.remove('opacity-100', 'translate-y-0', 'absolute');
            dropdownMenu.classList.add('opacity-0', 'translate-y-1', 'fixed');
